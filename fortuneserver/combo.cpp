    ...
    , networkSession(Q_NULLPTR)
{
    ...
    connect(hostCombo, &QComboBox::editTextChanged,
            this, &Combo::enableGetFortuneButton);
    connect(portLineEdit, &QLineEdit::textChanged,
            this, &Combo::enableGetFortuneButton);
    connect(addLineEdit, &QLineEdit::textEdited,
            this, &Combo::enableAddButton);
    connect(addLineEdit, &QLineEdit::editingFinished,
            this, &Combo::setNewFortune);
    connect(getFortuneButton, &QAbstractButton::clicked,
            this, &Combo::requestNewFortune);
    connect(addButton, &QPushButton::clicked,
            this, &Combo::addNewFortune);
    connect(quitButton, &QAbstractButton::clicked, this, &QWidget::close);
    connect(tcpSocket, &QIODevice::readyRead, this, &Combo::readFortune);
    typedef void (QAbstractSocket::*QAbstractSocketErrorSignal)(QAbstractSocket::SocketError);
    connect(tcpSocket, static_cast<QAbstractSocketErrorSignal>(&QAbstractSocket::error),
            this, &Combo::displayError);
    ...
    if (manager.capabilities() & QNetworkConfigurationManager::NetworkSessionRequired) {
        ...
        connect(networkSession, &QNetworkSession::opened, this, &Combo::sessionOpened);
...
void Combo::readFortune()
{
    if (fortuneStop == 0)
    {
        ...
        if (nextFortune == currentFortune) {
            QTimer::singleShot(0, this, &Combo::requestNewFortune);
            return;
        }
...
void Combo::displayError(QAbstractSocket::SocketError socketError)
{
    switch (socketError) {
    case QAbstractSocket::RemoteHostClosedError:
        break;
    case QAbstractSocket::HostNotFoundError:
        QMessageBox::information(this, tr("Fortune Combo"),
...
void Combo::enableGetFortuneButton()
{
    getFortuneButton->setEnabled((!networkSession || networkSession->isOpen()) &&
                                 !hostCombo->currentText().isEmpty() &&
                                 !portLineEdit->text().isEmpty());
}
void Combo::enableAddButton()
{
...
// this crashes the program // added stuff in combo.cpp constructor from server.cpp constructor to try to make it work
